...
def create_default_app() -> FastAPI:
    ...
    return create_app(
        ...
        executor=URRTDETrajectoryExecutor(
            ...
            joint_speed=_float_from_env("UR_JOINT_SPEED", 2.10),
            joint_accel=_float_from_env("UR_JOINT_ACCEL", 2.8),
            joint_blend=_float_from_env("UR_TRAJECTORY_BLEND_RADIUS", 0.02),
            trajectory_time_scale=_float_from_env("UR_TRAJECTORY_TIME_SCALE", 0.5),
            servo_lookahead_time=_float_from_env("UR_SERVO_LOOKAHEAD_TIME", 0.1),
            servo_gain=_float_from_env("UR_SERVO_GAIN", 300.0),
            completion_timeout_s=_float_from_env("UR_COMPLETION_TIMEOUT_S", 120.0),
